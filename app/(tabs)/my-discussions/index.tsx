...
import { usePaginatedAnnounceWithDiscussion } from "../../../src/hooks/announce/usePaginatedAnnounceWithDiscussion";
import { containerStyles } from "../../../src/styles/containerStyles";

export default function MyDiscussionsIndex() {
  const [currentPage, setCurrentPage] = useState(0);
  const { data, isLoading, isError, error } =
    usePaginatedAnnounceWithDiscussion({
      currentPage,
      size: 10,
    });
    ...
    <SafeAreaView style={{ flex: 1 }} edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={containerStyles.main}>
          <ViewTitle title="My discussions" />
